...
-- Date        : Sat Apr  4 16:19:15 2026
-- Host        : Ubuntu running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /media/ubuntu/large/radio-zcu208/vivado/adc.gen/sources_1/ip/clk_wiz_adc_band/clk_wiz_adc_band_sim_netlist.vhdl
-- Design      : clk_wiz_adc_band
...
entity clk_wiz_adc_band_clk_wiz is
  port (
...
end clk_wiz_adc_band_clk_wiz;

architecture STRUCTURE of clk_wiz_adc_band_clk_wiz is
  signal clk_out1_clk_wiz_adc_band : STD_LOGIC;
  signal clk_out1_clk_wiz_adc_band_en_clk : STD_LOGIC;
  signal clk_out2_clk_wiz_adc_band : STD_LOGIC;
  signal clk_out2_clk_wiz_adc_band_en_clk : STD_LOGIC;
  signal clkfbout_clk_wiz_adc_band : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_out1_clk_wiz_adc_band,
      O => clk_out1_clk_wiz_adc_band_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_out2_clk_wiz_adc_band,
      O => clk_out2_clk_wiz_adc_band_en_clk
    );
plle4_adv_inst: unisim.vcomponents.PLLE4_ADV
    generic map(
      ...
      CLKFBOUT => clkfbout_clk_wiz_adc_band,
      CLKIN => clk_in1,
      CLKOUT0 => clk_out1_clk_wiz_adc_band,
      CLKOUT0B => clk_out2_clk_wiz_adc_band,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_clk_wiz_adc_band_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_clk_wiz_adc_band_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
...
entity clk_wiz_adc_band is
  ...
  attribute NotValidForBitStream of clk_wiz_adc_band : entity is true;
end clk_wiz_adc_band;

architecture STRUCTURE of clk_wiz_adc_band is
begin
inst: entity work.clk_wiz_adc_band_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
