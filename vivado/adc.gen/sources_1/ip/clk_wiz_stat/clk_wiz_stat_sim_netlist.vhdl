...
entity clk_wiz_stat_clk_wiz is
  port (
...
architecture STRUCTURE of clk_wiz_stat_clk_wiz is
  signal clk_out1_clk_wiz_stat : STD_LOGIC;
  signal clk_out1_clk_wiz_stat_en_clk : STD_LOGIC;
  signal clk_out2_clk_wiz_stat : STD_LOGIC;
  signal clk_out2_clk_wiz_stat_en_clk : STD_LOGIC;
  signal clkfbout_clk_wiz_stat : STD_LOGIC;
...
entity clk_wiz_stat is
  ...
  attribute NotValidForBitStream of clk_wiz_stat : entity is true;
end clk_wiz_stat;

architecture STRUCTURE of clk_wiz_stat is
begin
inst: entity work.clk_wiz_stat_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
