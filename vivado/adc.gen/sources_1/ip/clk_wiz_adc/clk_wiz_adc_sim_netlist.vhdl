...
-- Date        : Fri Feb 13 16:33:39 2026
-- Host        : DESKTOP-SA3FM6F running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/radio-zcu208/vivado/adc.gen/sources_1/ip/clk_wiz_adc/clk_wiz_adc_sim_netlist.vhdl
-- Design      : clk_wiz_adc
...
end clk_wiz_adc_clk_wiz;

architecture STRUCTURE of clk_wiz_adc_clk_wiz is
  signal clk_out1_clk_wiz_adc : STD_LOGIC;
  signal clk_out1_clk_wiz_adc_en_clk : STD_LOGIC;
  signal clk_out2_clk_wiz_adc : STD_LOGIC;
  signal clk_out2_clk_wiz_adc_en_clk : STD_LOGIC;
  signal clkfbout_clk_wiz_adc : STD_LOGIC;
...
plle4_adv_inst: unisim.vcomponents.PLLE4_ADV
    generic map(
      ...
      CLKFBOUT => clkfbout_clk_wiz_adc,
      CLKIN => clk_in1,
      CLKOUT0 => clk_out1_clk_wiz_adc,
      CLKOUT0B => clk_out2_clk_wiz_adc,
...
entity clk_wiz_adc is
  ...
  attribute NotValidForBitStream of clk_wiz_adc : entity is true;
end clk_wiz_adc;

architecture STRUCTURE of clk_wiz_adc is
begin
inst: entity work.clk_wiz_adc_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
