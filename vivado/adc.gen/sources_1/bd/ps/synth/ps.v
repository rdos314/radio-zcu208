...
module ps
  ...
  ps_axi_int_0_0 axi_int_0
       (.M_AXI_AWADDR(axi_int_0_M_AXI_AWADDR),
        ...
        .wr_ptr(axi_int_0_wr_ptr));
  ps_axi_intc_0_0 axi_intc_0
       (.intr(r5_timer_interrupt),
        .irq(axi_intc_0_irq),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
