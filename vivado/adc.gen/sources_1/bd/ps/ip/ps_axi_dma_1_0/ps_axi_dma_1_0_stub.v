...
module ps_axi_dma_1_0(config_clk, config_wr, config_adr, config_data, 
  clk, resetn, irq, mig_rd_ptr, mig_wr_ptr, linux_wr_ptr, linux_rd_ptr, M_AXI_TDATA_in_cmd, 
  M_AXI_TVALID_in_cmd, M_AXI_TREADY_in_cmd, M_AXI_STS_in_tdata, M_AXI_STS_in_tvalid, 
  M_AXI_STS_in_tready, M_AXI_TDATA_out_cmd, M_AXI_TVALID_out_cmd, M_AXI_TREADY_out_cmd, 
  M_AXI_STS_out_tdata, M_AXI_STS_out_tvalid, M_AXI_STS_out_tready, M_AXI_TDATA_in, 
  M_AXI_TVALID_in, M_AXI_TREADY_in, M_AXI_TDATA_out, M_AXI_TVALID_out, M_AXI_TLAST_out, 
  M_AXI_TREADY_out)
/* synthesis syn_black_box black_box_pad_pin="config_clk,config_wr,config_adr[7:0],config_data[31:0],resetn,irq,mig_rd_ptr[26:0],mig_wr_ptr[26:0],linux_wr_ptr[31:0],linux_rd_ptr[31:0],M_AXI_TDATA_in_cmd[71:0],M_AXI_TVALID_in_cmd,M_AXI_TREADY_in_cmd,M_AXI_STS_in_tdata[7:0],M_AXI_STS_in_tvalid,M_AXI_STS_in_tready,M_AXI_TDATA_out_cmd[71:0],M_AXI_TVALID_out_cmd,M_AXI_TREADY_out_cmd,M_AXI_STS_out_tdata[7:0],M_AXI_STS_out_tvalid,M_AXI_STS_out_tready,M_AXI_TDATA_in[255:0],M_AXI_TVALID_in,M_AXI_TREADY_in,M_AXI_TDATA_out[255:0],M_AXI_TVALID_out,M_AXI_TLAST_out,M_AXI_TREADY_out" */
