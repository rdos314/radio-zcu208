...
module ps_comp_ana_0_0(fifo_clk, fifo_active, fifo_re, fifo_im, 
  fifo_burst, fifo_sample, fifo_size, fifo_freq, fifo_angle, config_clk, config_wr, config_adr, 
  config_data, clk, reset)
/* synthesis syn_black_box black_box_pad_pin="fifo_active,fifo_re[63:0],fifo_im[63:0],fifo_burst,fifo_sample[15:0],fifo_size[8:0],fifo_freq[19:0],fifo_angle[15:0],config_clk,config_wr,config_adr[7:0],config_data[31:0],reset" */
