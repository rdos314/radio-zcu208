...
// Command     : write_verilog -force -mode synth_stub -rename_top ps_axi_smc_2_0 -prefix
//               ps_axi_smc_2_0_ ps_axi_smc_2_0_stub.v
...
(* CHECK_LICENSE_TYPE = "ps_axi_smc_2_0,bd_c8e5,{}" *) (* CORE_GENERATION_INFO = "ps_axi_smc_2_0,bd_c8e5,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_c8e5,Vivado 2025.1" *) 
module ps_axi_smc_2_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
