...
architecture STRUCTURE of ps_deci_low_0_0_deci_low is
  ...
  signal \deci_low.raw_data[191]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \deci_low.raw_wr_i_1_n_0\ : STD_LOGIC;
...
\deci_low.raw_data[191]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5D555554"
    )
        port map (
      ...
      O => \deci_low.raw_data[191]_i_1_n_0\
    );
\deci_low.raw_data_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => \deci_low.raw_data[191]_i_1_n_0\,
      D => fir_raw_N(15),
      Q => raw_data(0),
      R => '0'
    );
...
\deci_low.raw_wr_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => mux_active,
      O => \deci_low.raw_wr_i_1_n_0\
    );
\deci_low.raw_wr_reg\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \deci_low.raw_wr_i_1_n_0\,
      Q => \^raw_wr\,
      R => '0'
    );
