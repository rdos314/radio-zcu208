...
module ps_comp_low_0_0(fifo_clk, fifo_wr, fifo_sample, fifo_size, 
...
/* synthesis syn_black_box black_box_pad_pin="fifo_clk,fifo_wr,fifo_sample[31:0],fifo_size[8:0],fifo_freq[19:0],fifo_angle[15:0],fifo_sample_N[5:0],fifo_sample_E[5:0],fifo_sample_W[5:0],clk,raw_active,raw_sample[63:0],raw_N[127:0],raw_E[127:0],raw_W[127:0]" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 fifo_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME fifo_clk, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ps_mts_0_0_ana0_clk, INSERT_VIP 0" *) input fifo_clk;
  input fifo_wr;
