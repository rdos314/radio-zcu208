...
// Command     : write_verilog -force -mode synth_stub -rename_top ps_util_ds_buf_0_1 -prefix
//               ps_util_ds_buf_0_1_ ps_util_ds_buf_0_1_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="IBUF_DS_P[0:0],IBUF_DS_N[0:0],IBUF_OUT[0:0]" */;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 IBUF_OUT CLK" *) (* x_interface_mode = "master IBUF_OUT" *) (* x_interface_parameter = "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ps_pl_sysref_n, INSERT_VIP 0" *) output [0:0]IBUF_OUT;
endmodule
