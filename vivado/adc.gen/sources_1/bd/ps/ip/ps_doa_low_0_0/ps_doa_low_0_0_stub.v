...
(* CHECK_LICENSE_TYPE = "ps_doa_low_0_0,doa_low,{}" *) (* CORE_GENERATION_INFO = "ps_doa_low_0_0,doa_low,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=doa_low,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "doa_low,Vivado 2025.1" *) 
module ps_doa_low_0_0(clk, reset, fifo_valid, fifo_data, valid_N, env_N, 
  phase_N, diff_N, valid_E, env_E, phase_E, diff_E, valid_W, env_W, phase_W, diff_W)
/* synthesis syn_black_box black_box_pad_pin="reset,fifo_valid,fifo_data[69:0],valid_N,env_N[15:0],phase_N[15:0],diff_N[15:0],valid_E,env_E[15:0],phase_E[15:0],diff_E[15:0],valid_W,env_W[15:0],phase_W[15:0],diff_W[15:0]" */
