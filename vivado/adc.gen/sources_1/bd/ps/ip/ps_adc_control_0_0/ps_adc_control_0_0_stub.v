...
module ps_adc_control_0_0(clk, resetn, bram_adr_in, bram_adr_out, address, 
  data_in, wr_en, data_out, adc_start, adc_stop, sim_start, adc_active, sim_active, sim_low_wr, 
  sim_high_wr, sim_channel, sim_data)
/* synthesis syn_black_box black_box_pad_pin="resetn,bram_adr_in[12:0],bram_adr_out[10:0],address[10:0],data_in[31:0],wr_en[3:0],data_out[31:0],adc_start,adc_stop,sim_start,adc_active,sim_active,sim_low_wr,sim_high_wr,sim_channel[1:0],sim_data[31:0]" */
