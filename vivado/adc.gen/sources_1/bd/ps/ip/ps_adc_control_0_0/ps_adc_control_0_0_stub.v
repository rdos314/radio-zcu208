...
module ps_adc_control_0_0(clk, resetn, reset_out, stop_in, address, data_in, 
  wr_en, data_out, adc_active, sim_active, sim_low_wr, sim_high_wr, sim_channel, sim_data)
/* synthesis syn_black_box black_box_pad_pin="resetn,reset_out,stop_in,address[10:0],data_in[31:0],wr_en[3:0],data_out[31:0],adc_active,sim_active,sim_low_wr,sim_high_wr,sim_channel[1:0],sim_data[31:0]" */
