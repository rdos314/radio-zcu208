...
module ps_adc_control_0_0(clk, reset_in, reset_out, stop_in, address, 
  data_in, wr_en, data_out, adc_active, sim_active, sim_low_wr, sim_high_wr, sim_channel, sim_data)
/* synthesis syn_black_box black_box_pad_pin="reset_in,reset_out,stop_in,address[10:0],data_in[31:0],wr_en[3:0],data_out[31:0],adc_active,sim_active,sim_low_wr,sim_high_wr,sim_channel[1:0],sim_data[31:0]" */
/* synthesis syn_force_seq_prim="clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ps_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
