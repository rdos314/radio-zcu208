...
-- Date        : Sun Mar  1 01:10:42 2026
-- Host        : DESKTOP-SA3FM6F running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top ps_ddr4_0_0 -prefix
--               ps_ddr4_0_0_ ps_ddr4_0_0_stub.vhdl
-- Design      : ps_ddr4_0_0
...
entity ps_ddr4_0_0 is
  ...
  attribute CORE_GENERATION_INFO of ps_ddr4_0_0 : entity is "DDR4_SDRAM, DDR4_SDRAM,{x_ipProduct=Vivado 2017.2.0,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=DDR4_SDRAM,x_ipVersion=2.2, Controller_Type = DDR4_SDRAM, Time_Period = 750, Input_Clock_Period = 3334, Memory_Type = Components, Memory_Part = MT40A1G8WE-075E, Ecc = false, Cas_Latency = 18, Cas_Write_Latency = 14, DQ_Width = 32, Chip_Select = true, Data_Mask = DM_NO_DBI, MEM_ADDR_ORDER = ROW_COLUMN_BANK,  Is_AXI_Enabled = true , Slot_cofiguration =  Single , Clamshell_cofiguration =  true ,IS_FASTER_SPEED_RAM = No, Is_custom_part = false, Memory_Voltage = 1.2V, Phy_Only = Complete_Memory_Controller, Debug_Port = Disable, Burst_Length = 8, System_Clock = Differential, AXI_Selection = true, AXI_Data_Width = 256,  AXI_ArbitrationScheme = RD_PRI_REG, AXI_Narrow_Burst = false, Simulation_Mode = BFM, Debug_Mode = Disable, Example_TG = SIMPLE_TG, Self_Refresh = false, Save_Restore = false, Enable_LVAUX = false,MicroBlaze_ECC = false,  Specify_MandD = false, CLKBOUT_MULT = 10, DIVCLK_DIVIDE = 3, CLKOUT0_DIVIDE = 3}";
  attribute dont_touch : string;
  attribute dont_touch of ps_ddr4_0_0 : entity is "true";
end ps_ddr4_0_0;

architecture stub of ps_ddr4_0_0 is
  ...
  attribute X_CORE_INFO of stub : architecture is "ddr4_v2_2_27,Vivado 2025.1";
begin
end;
