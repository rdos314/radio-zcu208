...
architecture STRUCTURE of ps_mts_0_0_mts is
  ...
  attribute async_reg of comp_ana1_reset_2 : signal is "true";
  signal comp_ana_locked : STD_LOGIC;
  ...
  signal \mts.stat_low_0_reset_1_reg0\ : STD_LOGIC;
  ...
  signal stat_0_locked : STD_LOGIC;
  signal \^stat_high_0_clk\ : STD_LOGIC;
  signal stat_high_0_reset_1 : STD_LOGIC;
  attribute async_reg of stat_high_0_reset_1 : signal is "true";
  signal stat_high_0_reset_2 : STD_LOGIC;
  attribute async_reg of stat_high_0_reset_2 : signal is "true";
  signal \^stat_low_0_clk\ : STD_LOGIC;
  signal stat_low_0_reset_1 : STD_LOGIC;
  attribute async_reg of stat_low_0_reset_1 : signal is "true";
  signal stat_low_0_reset_2 : STD_LOGIC;
  attribute async_reg of stat_low_0_reset_2 : signal is "true";
  ...
  attribute ASYNC_REG_boolean of \mts.comp_ana0_reset_1_reg\ : label is std.standard.true;
  attribute KEEP of \mts.comp_ana0_reset_1_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.comp_ana0_reset_2_reg\ : label is std.standard.true;
  attribute KEEP of \mts.comp_ana0_reset_2_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.comp_ana1_reset_1_reg\ : label is std.standard.true;
  attribute KEEP of \mts.comp_ana1_reset_1_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.comp_ana1_reset_2_reg\ : label is std.standard.true;
  attribute KEEP of \mts.comp_ana1_reset_2_reg\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \mts.stat_high_0_reset_1_reg\ : label is std.standard.true;
  attribute KEEP of \mts.stat_high_0_reset_1_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.stat_high_0_reset_2_reg\ : label is std.standard.true;
  attribute KEEP of \mts.stat_high_0_reset_2_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.stat_low_0_reset_1_reg\ : label is std.standard.true;
  attribute KEEP of \mts.stat_low_0_reset_1_reg\ : label is "yes";
  attribute ASYNC_REG_boolean of \mts.stat_low_0_reset_2_reg\ : label is std.standard.true;
  attribute KEEP of \mts.stat_low_0_reset_2_reg\ : label is "yes";
  ...
  attribute X_INTERFACE_PARAMETER of comp_ana0_clk : signal is "XIL_INTERFACENAME COMP_ANA0_CLK, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0";
  attribute X_INTERFACE_PARAMETER of comp_ana1_clk : signal is "XIL_INTERFACENAME COMP_ANA1_CLK, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0";
  ...
  attribute X_INTERFACE_PARAMETER of stat_high_0_clk : signal is "XIL_INTERFACENAME STAT_HIGH0_CLK, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0";
  attribute X_INTERFACE_PARAMETER of stat_low_0_clk : signal is "XIL_INTERFACENAME STAT_LOW0_CLK, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0";
begin
  ana0_clk <= \^ana0_clk\;
  ana1_clk <= \^ana1_clk\;
  comp0_clk <= \^comp0_clk\;
...
clk_wiz_comp_ana_i: component ps_mts_0_0_clk_wiz_adc
     port map (
      clk_in1 => pl_clk_buf,
...
clk_wiz_stat_0: component ps_mts_0_0_clk_wiz_adc_HD1
     port map (
      clk_in1 => pl_clk_buf,
...
\mts.comp_ana0_reset_1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => deci_reset_async,
      I1 => comp_ana_locked,
      O => \mts.comp_ana0_reset_1_reg0\
    );
\mts.comp_ana0_reset_1_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana0_clk\,
      CE => '1',
      D => \mts.comp_ana0_reset_1_reg0\,
      Q => comp_ana0_reset_1,
      R => '0'
    );
\mts.comp_ana0_reset_2_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana0_clk\,
      CE => '1',
      D => comp_ana0_reset_1,
...
\mts.comp_ana0_reset_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana0_clk\,
      CE => '1',
      D => comp_ana0_reset_2,
...
\mts.comp_ana1_reset_1_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana1_clk\,
      CE => '1',
      D => \mts.comp_ana0_reset_1_reg0\,
...
\mts.comp_ana1_reset_2_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana1_clk\,
      CE => '1',
      D => comp_ana1_reset_1,
...
\mts.comp_ana1_reset_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^comp_ana1_clk\,
      CE => '1',
      D => comp_ana1_reset_2,
...
\mts.stat_high_0_reset_1_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_high_0_clk\,
      CE => '1',
...
\mts.stat_high_0_reset_2_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_high_0_clk\,
      CE => '1',
...
\mts.stat_high_0_reset_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_high_0_clk\,
      CE => '1',
...
\mts.stat_low_0_reset_1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\mts.stat_low_0_reset_1_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_low_0_clk\,
      CE => '1',
      D => \mts.stat_low_0_reset_1_reg0\,
...
\mts.stat_low_0_reset_2_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_low_0_clk\,
      CE => '1',
...
\mts.stat_low_0_reset_reg\: unisim.vcomponents.FDRE
     port map (
      C => \^stat_low_0_clk\,
      CE => '1',
