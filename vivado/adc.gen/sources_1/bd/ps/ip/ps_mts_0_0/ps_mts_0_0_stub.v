...
module ps_mts_0_0(pl_clk, pl_sysref, sys_reset, axi_clk, 
  axi_reset_in, axi_reset_out, axi_adc_active, axi_sim_active, axi_stop, deci_clk, deci_resetn, 
  deci_stop_low, deci_stop_high, deci_adc_active, deci_sim_active, comp0_clk, comp0_reset, 
  comp1_clk, comp1_reset, doa0_clk, doa0_reset, doa1_clk, doa1_reset, user_sysref_adc)
/* synthesis syn_black_box black_box_pad_pin="pl_sysref,sys_reset,axi_reset_in,axi_reset_out,axi_adc_active,axi_sim_active,axi_stop,deci_resetn,deci_stop_low,deci_stop_high,deci_adc_active,deci_sim_active,comp0_reset,comp1_reset,doa0_reset,doa1_reset,user_sysref_adc" */
