...
module ps_mts_0_0(pl_clk, m_clk, pl_sysref, user_sysref_adc)
/* synthesis syn_black_box black_box_pad_pin="pl_sysref,user_sysref_adc" */
...
/* synthesis syn_force_seq_prim="m_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 m_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_clk, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ps_clk_wiz_0_0_clk_out1, INSERT_VIP 0" *) input m_clk /* synthesis syn_isclock = 1 */;
  input pl_sysref;
