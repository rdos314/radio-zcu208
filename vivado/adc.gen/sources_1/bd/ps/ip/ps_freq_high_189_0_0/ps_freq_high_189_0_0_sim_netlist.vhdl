...
architecture STRUCTURE of \ps_freq_high_189_0_0_morlet_to_phase_env__xdcDup__1\ is
  ...
  attribute x_core_info of tan2_i : label is "cordic_v6_0_24,Vivado 2025.1";
begin
\freq_high_189.doa_wr_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
entity ps_freq_high_189_0_0_phase_err is
  ...
  attribute keep_hierarchy of ps_freq_high_189_0_0_phase_err : entity is "soft";
end ps_freq_high_189_0_0_phase_err;

architecture STRUCTURE of ps_freq_high_189_0_0_phase_err is
  component ps_freq_high_189_0_0_ila_7 is
  port (
    clk : in STD_LOGIC;
  ...
  end component ps_freq_high_189_0_0_ila_7;
...
begin
  ...
  valid <= \^valid\;
ila_i: component ps_freq_high_189_0_0_ila_7
     port map (
      clk => clk,
      probe0(0) => \^valid\,
      probe1(0) => active,
...
architecture STRUCTURE of ps_freq_high_189_0_0_freq_high_189 is
  ...
  signal NLW_phase_err_i_valid_UNCONNECTED : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \freq_high_189.freq_rd_delay[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \freq_high_189.freq_rd_delay[1]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \freq_high_189.start_delay[6]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \freq_high_189.start_delay[7]_i_6\ : label is "soft_lutpair6";
  attribute KEEP_HIERARCHY : string;
