...
architecture STRUCTURE of ps_axi_int_0_0_axi_int is
  ...
  signal \axi_int.M_AXI_AWLEN[4]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \axi_int.M_AXI_AWLEN[7]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \axi_int.req_timeout[1]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[2]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[3]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[4]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[5]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[6]_i_1_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[7]_i_2_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[7]_i_3_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout[7]_i_4_n_0\ : STD_LOGIC;
  signal \axi_int.req_timeout_reg0\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
\axi_int.M_AXI_AWLEN[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\axi_int.M_AXI_AWLEN[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\axi_int.M_AXI_WDATA[39]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\axi_int.M_AXI_WDATA[39]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAEAAA2A"
    )
        port map (
...
\axi_int.busy_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000544454445444"
    )
        port map (
      I0 => reset,
      I1 => busy,
...
\axi_int.req_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\axi_int.req_timeout[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_int.req_timeout[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\axi_int.req_timeout[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
    )
        port map (
...
\axi_int.req_timeout[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\axi_int.size[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\axi_int.size[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
ila_i: component ps_axi_int_0_0_ila_6
     port map (
      clk => clk,
      probe0(0) => up,
      probe1(30 downto 0) => \^m_axi_awaddr\(30 downto 0),
