...
module ps_axi_int_0_0(clk, resetn, low_rd, low_wr, low_empty, low_full, 
  ...
  high_timestamp, high_data, lpd_clk, lpd_rd_ptr, lpd_wr_ptr, up, M_AXI_AWADDR, M_AXI_AWLEN, 
  M_AXI_AWSIZE, M_AXI_AWPROT, M_AXI_AWBURST, M_AXI_WSTRB, M_AXI_AWVALID, M_AXI_AWREADY, 
  M_AXI_WDATA, M_AXI_WLAST, M_AXI_WVALID, M_AXI_WREADY, M_AXI_BVALID, M_AXI_BRESP, 
  M_AXI_BREADY)
/* synthesis syn_black_box black_box_pad_pin="resetn,low_rd,low_wr,low_empty,low_full,low_pending,low_timestamp[21:0],low_data[255:0],high_rd,high_wr,high_empty,high_full,high_pending,high_timestamp[21:0],high_data[255:0],lpd_rd_ptr[31:0],lpd_wr_ptr[31:0],up,M_AXI_AWADDR[31:0],M_AXI_AWLEN[7:0],M_AXI_AWSIZE[2:0],M_AXI_AWPROT[1:0],M_AXI_AWBURST[1:0],M_AXI_WSTRB[31:0],M_AXI_AWVALID,M_AXI_AWREADY,M_AXI_WDATA[255:0],M_AXI_WLAST,M_AXI_WVALID,M_AXI_WREADY,M_AXI_BVALID,M_AXI_BRESP[1:0],M_AXI_BREADY" */
/* synthesis syn_force_seq_prim="clk" */
/* synthesis syn_force_seq_prim="lpd_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF M_AXI, FREQ_HZ 333250000, FREQ_TOLERANCE_HZ 0, PHASE 0.00, CLK_DOMAIN ps_ddr4_0_0_c0_ddr4_ui_clk, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 lpd_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME lpd_clk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ps_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input lpd_clk /* synthesis syn_isclock = 1 */;
