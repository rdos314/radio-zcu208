...
--               c:/radio-zcu208/vivado/adc.gen/sources_1/bd/ps/ip/ps_raw_0_0/ps_raw_0_0_sim_netlist.vhdl
-- Design      : ps_raw_0_0
...
entity ps_raw_0_0_raw is
  ...
  attribute ORIG_REF_NAME of ps_raw_0_0_raw : entity is "raw";
  attribute keep_hierarchy : string;
  attribute keep_hierarchy of ps_raw_0_0_raw : entity is "soft";
end ps_raw_0_0_raw;

architecture STRUCTURE of ps_raw_0_0_raw is
  component ps_raw_0_0_fifo_raw_high is
  port (
    rst : in STD_LOGIC;
    wr_clk : in STD_LOGIC;
    rd_clk : in STD_LOGIC;
  ...
  end component ps_raw_0_0_fifo_raw_high;
  component ps_raw_0_0_ila_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component ps_raw_0_0_ila_0;
...
fifo_raw_i: component ps_raw_0_0_fifo_raw_high
     port map (
...
ila_i: component ps_raw_0_0_ila_0
     port map (
      clk => clk,
      probe0(0) => raw_empty,
      probe1(0) => raw_rd,
...
entity ps_raw_0_0 is
  ...
  attribute NotValidForBitStream of ps_raw_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  ...
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of ps_raw_0_0 : entity is "raw,Vivado 2025.1";
end ps_raw_0_0;

architecture STRUCTURE of ps_raw_0_0 is
...
begin
inst: entity work.ps_raw_0_0_raw
     port map (
      active => active,
      clk => clk,
      fifo_clk => fifo_clk,
