...
#
# Script generated by Vivado on Mon Feb 16 00:15:35 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mul_stat24.sh
...
#
# Usage        : mul_stat24.sh
#                mul_stat24.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mul_stat24.sh [-reset_run]
#                mul_stat24.sh [-reset_log]
#                mul_stat24.sh [-help]
#
...
# script info
echo -e "mul_stat24.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mul_stat24.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_23 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mul_stat24 xil_defaultlib.mul_stat24 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mul_stat24 -key {Behavioral:sim_1:Functional:mul_stat24} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul_stat24.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mul_stat24.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mul_stat24.sh [-help]\n\
Usage: mul_stat24.sh [-step]\n\
Usage: mul_stat24.sh [-lib_map_path]\n\
Usage: mul_stat24.sh [-reset_run]\n\
Usage: mul_stat24.sh [-reset_log]\n\
Usage: mul_stat24.sh [-keep_index]\n\
Usage: mul_stat24.sh [-noclean_files]\n\n\
