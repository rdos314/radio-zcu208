...
#
# Script generated by Vivado on Wed Feb 04 19:44:08 +0100 2026
...
simulate()
{
  xsim fifo_stat_meta -key {Behavioral:sim_1:Functional:fifo_stat_meta} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
