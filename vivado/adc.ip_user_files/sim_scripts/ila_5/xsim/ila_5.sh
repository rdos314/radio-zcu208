...
simulate()
{
  xsim ila_5 -key {Behavioral:sim_1:Functional:ila_5} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
