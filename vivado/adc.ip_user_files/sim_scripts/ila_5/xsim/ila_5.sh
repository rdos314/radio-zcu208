...
#
# Script generated by Vivado on Thu Nov 27 23:50:00 +0100 2025
...
simulate()
{
  xsim ila_5 -key {Behavioral:sim_1:Functional:ila_5} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
