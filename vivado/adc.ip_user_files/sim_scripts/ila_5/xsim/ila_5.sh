...
#
# Script generated by Vivado on Fri Apr 24 16:52:47 CEST 2026
...
simulate()
{
  xsim ila_5 -key {Behavioral:sim_1:Functional:ila_5} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/bd_c815.protoinst" -log simulate.log
}
