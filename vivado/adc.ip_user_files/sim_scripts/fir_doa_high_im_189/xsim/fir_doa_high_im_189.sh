...
#
# Script generated by Vivado on Fri Jan 23 21:27:50 +0100 2026
...
simulate()
{
  xsim fir_doa_high_im_189 -key {Behavioral:sim_1:Functional:fir_doa_high_im_189} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
