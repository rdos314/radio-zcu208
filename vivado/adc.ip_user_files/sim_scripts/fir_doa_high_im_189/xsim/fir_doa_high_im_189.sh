...
#
# Script generated by Vivado on Fri Nov 14 22:42:26 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fir_doa_high_im_189.sh
...
#
# Usage        : fir_doa_high_im_189.sh
#                fir_doa_high_im_189.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_doa_high_im_189.sh [-reset_run]
#                fir_doa_high_im_189.sh [-reset_log]
#                fir_doa_high_im_189.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_21 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_21 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "fir_doa_high_im_189.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_doa_high_im_189.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L fir_compiler_v7_2_24 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fir_doa_high_im_189 xil_defaultlib.fir_doa_high_im_189 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_doa_high_im_189 -key {Behavioral:sim_1:Functional:fir_doa_high_im_189} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_doa_high_im_189.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_doa_high_im_189.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_doa_high_im_189.sh [-help]\n\
Usage: fir_doa_high_im_189.sh [-step]\n\
Usage: fir_doa_high_im_189.sh [-lib_map_path]\n\
Usage: fir_doa_high_im_189.sh [-reset_run]\n\
Usage: fir_doa_high_im_189.sh [-reset_log]\n\
Usage: fir_doa_high_im_189.sh [-keep_index]\n\
Usage: fir_doa_high_im_189.sh [-noclean_files]\n\n\
