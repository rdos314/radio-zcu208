...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/bd_c815.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
