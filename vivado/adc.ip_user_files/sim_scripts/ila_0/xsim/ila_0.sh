...
#
# Script generated by Vivado on Mon Feb 02 23:00:51 +0100 2026
...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
