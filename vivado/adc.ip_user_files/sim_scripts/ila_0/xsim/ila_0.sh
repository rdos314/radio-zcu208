...
#
# Script generated by Vivado on Tue Sep 30 22:33:48 +0200 2025
...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_2bb5.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
