...
#
# Script generated by Vivado on Fri Mar 06 21:30:55 +0100 2026
...
#
# Usage        : div_var.sh
#                div_var.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_var.sh [-reset_run]
#                div_var.sh [-reset_log]
#                div_var.sh [-help]
#
...
# script info
echo -e "div_var.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_var.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_23 -L floating_point_v7_0_25 -L div_gen_v5_1_24 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot div_var xil_defaultlib.div_var xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim div_var -key {Behavioral:sim_1:Functional:div_var} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb div_var.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_var.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_var.sh [-help]\n\
Usage: div_var.sh [-step]\n\
Usage: div_var.sh [-lib_map_path]\n\
Usage: div_var.sh [-reset_run]\n\
Usage: div_var.sh [-reset_log]\n\
Usage: div_var.sh [-keep_index]\n\
Usage: div_var.sh [-noclean_files]\n\n\
