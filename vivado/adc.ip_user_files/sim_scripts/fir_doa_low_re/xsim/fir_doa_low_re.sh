...
#
# Script generated by Vivado on Fri Jan 23 21:24:26 +0100 2026
...
simulate()
{
  xsim fir_doa_low_re -key {Behavioral:sim_1:Functional:fir_doa_low_re} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
