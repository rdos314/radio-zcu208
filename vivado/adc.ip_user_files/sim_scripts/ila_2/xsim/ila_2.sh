...
#
# Script generated by Vivado on Sat Nov 15 23:12:15 +0100 2025
...
simulate()
{
  xsim ila_2 -key {Behavioral:sim_1:Functional:ila_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
