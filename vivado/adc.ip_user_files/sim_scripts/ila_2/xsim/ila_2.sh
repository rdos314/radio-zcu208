...
#
# Script generated by Vivado on Fri Jan 30 18:28:11 +0100 2026
...
simulate()
{
  xsim ila_2 -key {Behavioral:sim_1:Functional:ila_2} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
