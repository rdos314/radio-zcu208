...
simulate()
{
  xsim ila_2 -key {Behavioral:sim_1:Functional:ila_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/bd_c815.protoinst" -protoinst "protoinst_files/bd_c8e5.protoinst" -log simulate.log
}
