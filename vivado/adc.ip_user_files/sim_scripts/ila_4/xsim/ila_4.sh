...
#
# Script generated by Vivado on Sat Nov 22 00:00:59 +0100 2025
...
simulate()
{
  xsim ila_4 -key {Behavioral:sim_1:Functional:ila_4} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
