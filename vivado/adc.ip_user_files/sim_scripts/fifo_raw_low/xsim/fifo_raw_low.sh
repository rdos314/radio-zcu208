...
#
# Script generated by Vivado on Wed Dec 10 23:26:39 +0100 2025
...
simulate()
{
  xsim fifo_raw_low -key {Behavioral:sim_1:Functional:fifo_raw_low} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
