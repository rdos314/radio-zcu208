...
#
# Script generated by Vivado on Tue Nov 25 23:10:32 +0100 2025
...
simulate()
{
  xsim fifo_raw_low -key {Behavioral:sim_1:Functional:fifo_raw_low} -tclbatch cmd.tcl -log simulate.log
}
