...
#
# Script generated by Vivado on Thu May 07 21:07:30 CEST 2026
...
simulate()
{
  xsim ila_9 -key {Behavioral:sim_1:Functional:ila_9} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/bd_c815.protoinst" -protoinst "protoinst_files/bd_c8e5.protoinst" -log simulate.log
}
