...
#
# Script generated by Vivado on Tue Jan 13 21:00:26 +0100 2026
...
simulate()
{
  xsim fifo_comp_ana -key {Behavioral:sim_1:Functional:fifo_comp_ana} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
