...
#
# Script generated by Vivado on Mon Dec 22 20:57:05 +0100 2025
...
#
# Usage        : div_env.sh
#                div_env.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_env.sh [-reset_run]
#                div_env.sh [-reset_log]
#                div_env.sh [-help]
#
...
# script info
echo -e "div_env.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_env.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb div_env.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_env.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_env.sh [-help]\n\
Usage: div_env.sh [-step]\n\
Usage: div_env.sh [-lib_map_path]\n\
Usage: div_env.sh [-reset_run]\n\
Usage: div_env.sh [-reset_log]\n\
Usage: div_env.sh [-keep_index]\n\
Usage: div_env.sh [-noclean_files]\n\n\
