...
#
# Script generated by Vivado on Wed Nov 26 20:02:42 +0100 2025
...
simulate()
{
  xsim fifo_raw_high -key {Behavioral:sim_1:Functional:fifo_raw_high} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
