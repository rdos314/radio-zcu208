...
#
# Script generated by Vivado on Mon Dec 15 21:14:03 +0100 2025
...
simulate()
{
  xsim fifo_doa_high -key {Behavioral:sim_1:Functional:fifo_doa_high} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
