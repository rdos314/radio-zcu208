...
#
# Script generated by Vivado on Sun Jan 04 20:30:35 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sqrt_err.sh
...
#
# Usage        : sqrt_err.sh
#                sqrt_err.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sqrt_err.sh [-reset_run]
#                sqrt_err.sh [-reset_log]
#                sqrt_err.sh [-help]
#
...
# script info
echo -e "sqrt_err.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sqrt_err.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sqrt_err.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sqrt_err.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sqrt_err.sh [-help]\n\
Usage: sqrt_err.sh [-step]\n\
Usage: sqrt_err.sh [-lib_map_path]\n\
Usage: sqrt_err.sh [-reset_run]\n\
Usage: sqrt_err.sh [-reset_log]\n\
Usage: sqrt_err.sh [-keep_index]\n\
Usage: sqrt_err.sh [-noclean_files]\n\n\
