...
#
# Script generated by Vivado on Sun Nov 23 20:52:56 +0100 2025
...
simulate()
{
  xsim fifo_sim -key {Behavioral:sim_1:Functional:fifo_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
