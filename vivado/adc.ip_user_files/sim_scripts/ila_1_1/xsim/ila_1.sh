...
#
# Script generated by Vivado on Fri Mar 06 22:09:19 +0100 2026
...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -log simulate.log
}
