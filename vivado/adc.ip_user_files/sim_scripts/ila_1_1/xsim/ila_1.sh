...
#
# Script generated by Vivado on Sun Nov 02 18:48:48 +0100 2025
...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -log simulate.log
}
