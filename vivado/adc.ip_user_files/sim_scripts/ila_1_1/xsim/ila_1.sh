...
#
# Script generated by Vivado on Mon Dec 01 23:24:44 +0100 2025
...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
