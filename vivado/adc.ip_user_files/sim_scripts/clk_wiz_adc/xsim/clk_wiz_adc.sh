...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_adc xil_defaultlib.clk_wiz_adc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_adc -key {Behavioral:sim_1:Functional:clk_wiz_adc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_adc.wdb xsim.dir libdpi.so)
