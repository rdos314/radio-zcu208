...
#
# Script generated by Vivado on Mon Apr 20 23:18:04 CEST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_spy.sh
...
#
# Usage        : fifo_spy.sh
#                fifo_spy.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_spy.sh [-reset_run]
#                fifo_spy.sh [-reset_log]
#                fifo_spy.sh [-help]
#
...
#                script (type 'fifo_spy.sh -help' for more information).
#
...
# script info
echo -e "fifo_spy.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_spy.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_spy xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_spy -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_spy_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_spy.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_spy.sh [-help]\n\
Usage: fifo_spy.sh [-step]\n\
Usage: fifo_spy.sh [-lib_map_path]\n\
Usage: fifo_spy.sh [-reset_run]\n\
Usage: fifo_spy.sh [-reset_log]\n\
Usage: fifo_spy.sh [-keep_index]\n\
Usage: fifo_spy.sh [-noclean_files]\n\n\
