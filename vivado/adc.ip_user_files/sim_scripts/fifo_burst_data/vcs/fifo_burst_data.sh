...
design_libs=(xilinx_vip xpm fifo_generator_v13_2_13 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_13 $vlogan_opts +v2k +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_burst_data xil_defaultlib.glbl -o fifo_burst_data_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_burst_data_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/ubuntu/large/radio-zcu208/vivado/adc.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fifo_burst_data_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_burst_data_simv.daidir vcs_lib c.obj)
