...
#
# Script generated by Vivado on Fri Mar 27 18:30:44 CET 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_burst_data.sh
...
#
# Usage        : fifo_burst_data.sh
#                fifo_burst_data.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_burst_data.sh [-reset_run]
#                fifo_burst_data.sh [-reset_log]
#                fifo_burst_data.sh [-help]
#
...
#                script (type 'fifo_burst_data.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname fifo_generator_v13_2_13 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm fifo_generator_v13_2_13 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_burst_data.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_burst_data.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_13 $xmvlog_opts +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/large/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_burst_data xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_burst_data -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/ubuntu/large/radio-zcu208/vivado/adc.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_burst_data_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_burst_data.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_burst_data.sh [-help]\n\
Usage: fifo_burst_data.sh [-step]\n\
Usage: fifo_burst_data.sh [-lib_map_path]\n\
Usage: fifo_burst_data.sh [-reset_run]\n\
Usage: fifo_burst_data.sh [-reset_log]\n\
Usage: fifo_burst_data.sh [-keep_index]\n\
Usage: fifo_burst_data.sh [-noclean_files]\n\n\
