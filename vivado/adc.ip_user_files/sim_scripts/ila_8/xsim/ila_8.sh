...
#
# Script generated by Vivado on Sun May 10 23:34:41 CEST 2026
...
# script info
echo -e "ila_8.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_8 xil_defaultlib.ila_8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_8 -key {Behavioral:sim_1:Functional:ila_8} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/bd_c815.protoinst" -protoinst "protoinst_files/bd_c8e5.protoinst" -protoinst "protoinst_files/bd_2bb5.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
