...
#
# Script generated by Vivado on Fri Mar 13 22:36:30 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_wiz_stat.sh
...
#
# Usage        : clk_wiz_stat.sh
#                clk_wiz_stat.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_stat.sh [-reset_run]
#                clk_wiz_stat.sh [-reset_log]
#                clk_wiz_stat.sh [-help]
#
...
# script info
echo -e "clk_wiz_stat.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_stat.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_stat xil_defaultlib.clk_wiz_stat xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_stat -key {Behavioral:sim_1:Functional:clk_wiz_stat} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/bd_811f.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_stat.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_stat.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_stat.sh [-help]\n\
Usage: clk_wiz_stat.sh [-step]\n\
Usage: clk_wiz_stat.sh [-lib_map_path]\n\
Usage: clk_wiz_stat.sh [-reset_run]\n\
Usage: clk_wiz_stat.sh [-reset_log]\n\
Usage: clk_wiz_stat.sh [-keep_index]\n\
Usage: clk_wiz_stat.sh [-noclean_files]\n\n\
