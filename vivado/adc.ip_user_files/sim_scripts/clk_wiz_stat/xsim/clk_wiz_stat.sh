...
#
# Script generated by Vivado on Sun Mar 15 22:51:29 +0100 2026
...
simulate()
{
  xsim clk_wiz_stat -key {Behavioral:sim_1:Functional:clk_wiz_stat} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e41.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
