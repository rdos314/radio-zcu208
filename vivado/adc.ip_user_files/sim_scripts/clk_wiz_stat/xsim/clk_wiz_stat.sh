...
#
# Script generated by Vivado on Sun Feb 15 14:28:21 +0100 2026
...
simulate()
{
  xsim clk_wiz_stat -key {Behavioral:sim_1:Functional:clk_wiz_stat} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
