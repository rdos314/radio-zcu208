...
#
# Script generated by Vivado on Sat Nov 15 14:01:54 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mult_16_16.sh
...
#
# Usage        : mult_16_16.sh
#                mult_16_16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_16_16.sh [-reset_run]
#                mult_16_16.sh [-reset_log]
#                mult_16_16.sh [-help]
#
...
# script info
echo -e "mult_16_16.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_16_16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_23 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_16_16 xil_defaultlib.mult_16_16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_16_16 -key {Behavioral:sim_1:Functional:mult_16_16} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_16_16.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_16_16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_16_16.sh [-help]\n\
Usage: mult_16_16.sh [-step]\n\
Usage: mult_16_16.sh [-lib_map_path]\n\
Usage: mult_16_16.sh [-reset_run]\n\
Usage: mult_16_16.sh [-reset_log]\n\
Usage: mult_16_16.sh [-keep_index]\n\
Usage: mult_16_16.sh [-noclean_files]\n\n\
