...
#
# Script generated by Vivado on Fri Jan 09 20:41:53 +0100 2026
...
simulate()
{
  xsim ila_6 -key {Behavioral:sim_1:Functional:ila_6} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
