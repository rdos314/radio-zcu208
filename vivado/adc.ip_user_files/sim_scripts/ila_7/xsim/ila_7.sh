...
#
# Script generated by Vivado on Mon Dec 22 21:27:33 +0100 2025
...
simulate()
{
  xsim ila_7 -key {Behavioral:sim_1:Functional:ila_7} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
