...
simulate()
{
  xsim ila_7 -key {Behavioral:sim_1:Functional:ila_7} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/bd_5e41.protoinst" -log simulate.log
}
