...
#
# Script generated by Vivado on Wed Nov 26 00:03:31 +0100 2025
...
simulate()
{
  xsim fir_raw_deci -key {Behavioral:sim_1:Functional:fir_raw_deci} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
