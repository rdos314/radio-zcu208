...
#
# Script generated by Vivado on Sat Nov 08 15:05:47 +0100 2025
...
simulate()
{
  xsim ila_3 -key {Behavioral:sim_1:Functional:ila_3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
