...
#
# Script generated by Vivado on Sun Nov 30 19:15:41 +0100 2025
...
simulate()
{
  xsim ila_3 -key {Behavioral:sim_1:Functional:ila_3} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
