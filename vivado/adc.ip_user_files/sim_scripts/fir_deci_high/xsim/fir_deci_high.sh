...
#
# Script generated by Vivado on Wed Nov 26 20:01:52 +0100 2025
...
simulate()
{
  xsim fir_deci_high -key {Behavioral:sim_1:Functional:fir_deci_high} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
