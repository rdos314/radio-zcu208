...
#
# Script generated by Vivado on Sun Nov 30 00:30:29 +0100 2025
...
simulate()
{
  xsim fifo_doa_low -key {Behavioral:sim_1:Functional:fifo_doa_low} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
