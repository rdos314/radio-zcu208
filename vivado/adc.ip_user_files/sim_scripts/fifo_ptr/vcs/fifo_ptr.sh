...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_ptr xil_defaultlib.glbl -o fifo_ptr_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_ptr_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_ptr_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_ptr_simv.daidir vcs_lib c.obj)
