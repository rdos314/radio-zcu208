...
#
# Script generated by Vivado on Tue Dec 30 15:48:44 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : doa_sincos.sh
...
#
# Usage        : doa_sincos.sh
#                doa_sincos.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                doa_sincos.sh [-reset_run]
#                doa_sincos.sh [-reset_log]
#                doa_sincos.sh [-help]
#
...
# script info
echo -e "doa_sincos.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./doa_sincos.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb doa_sincos.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./doa_sincos.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: doa_sincos.sh [-help]\n\
Usage: doa_sincos.sh [-step]\n\
Usage: doa_sincos.sh [-lib_map_path]\n\
Usage: doa_sincos.sh [-reset_run]\n\
Usage: doa_sincos.sh [-reset_log]\n\
Usage: doa_sincos.sh [-keep_index]\n\
Usage: doa_sincos.sh [-noclean_files]\n\n\
