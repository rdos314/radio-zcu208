...
#
# Script generated by Vivado on Fri Jan 16 21:54:28 +0100 2026
...
simulate()
{
  xsim fifo_ana -key {Behavioral:sim_1:Functional:fifo_ana} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
