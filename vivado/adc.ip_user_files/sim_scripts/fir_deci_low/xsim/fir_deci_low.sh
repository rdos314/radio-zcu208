...
#
# Script generated by Vivado on Wed Nov 26 19:56:27 +0100 2025
...
simulate()
{
  xsim fir_deci_low -key {Behavioral:sim_1:Functional:fir_deci_low} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
