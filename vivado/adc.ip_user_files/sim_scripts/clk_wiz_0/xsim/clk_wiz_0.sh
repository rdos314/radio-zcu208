...
#
# Script generated by Vivado on Fri Oct 03 21:20:12 +0200 2025
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -log simulate.log
}
