...
#
# Script generated by Vivado on Sun Feb 15 18:42:05 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_add16.sh
...
#
# Usage        : dsp_add16.sh
#                dsp_add16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_add16.sh [-reset_run]
#                dsp_add16.sh [-reset_log]
#                dsp_add16.sh [-help]
#
...
# script info
echo -e "dsp_add16.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_add16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_dsp48_wrapper_v3_0_7 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_8 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dsp_add16 xil_defaultlib.dsp_add16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_add16 -key {Behavioral:sim_1:Functional:dsp_add16} -tclbatch cmd.tcl -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_add16.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_add16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_add16.sh [-help]\n\
Usage: dsp_add16.sh [-step]\n\
Usage: dsp_add16.sh [-lib_map_path]\n\
Usage: dsp_add16.sh [-reset_run]\n\
Usage: dsp_add16.sh [-reset_log]\n\
Usage: dsp_add16.sh [-keep_index]\n\
Usage: dsp_add16.sh [-noclean_files]\n\n\
