...
HD_PWD='C:/radio-zcu208/vivado/adc/adc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_wrapper.tcl
