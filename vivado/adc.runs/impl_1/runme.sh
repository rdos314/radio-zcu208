...
HD_PWD='C:/radio-zcu208/vivado/adc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_wrapper.tcl -notrace
