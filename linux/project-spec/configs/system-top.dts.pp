# 0 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts"
/dts-v1/;
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 1
# 15 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi"
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/dma/xlnx-zynqmp-dpdma.h" 1
# 16 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/gpio/gpio.h" 1
# 17 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/interrupt-controller/arm-gic.h" 1
# 9 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/interrupt-controller/arm-gic.h"
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/interrupt-controller/irq.h" 1
# 10 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/interrupt-controller/arm-gic.h" 2
# 18 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/interrupt-controller/irq.h" 1
# 19 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/power/xlnx-zynqmp-power.h" 1
# 20 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/reset/xlnx-zynqmp-resets.h" 1
# 21 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/thermal/thermal.h" 1
# 22 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp.dtsi" 2
...
# 3 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp-u-boot.dtsi" 1
...
# 4 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp-clk-ccf.dtsi" 1
# 11 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp-clk-ccf.dtsi"
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/include/dt-bindings/clock/xlnx-zynqmp-clk.h" 1
# 12 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/zynqmp-clk-ccf.dtsi" 2
/ {
...
# 5 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <2>;
  #size-cells = <2>;
  firmware-name = "ps_wrapper.bit.bin";
  clocking0: clocking0 {
  ...
  clk104_mux: gpio@80040000 {
   ...
   xlnx,name = "clk104_mux";
   xlnx,all-inputs = <0>;
  };
  gpio_led: gpio@80050000 {
  ...
  usp_rf_data_converter_0: usp_rf_data_converter@80080000 {
   xlnx,adc-tdd-rts21 = <0>;
   xlnx,adc3-fabric-freq = <500>;
   xlnx,adc-dither32;
   xlnx,dac2-clock-source-mx = <6>;
   xlnx,adc-tdd-rts22 = <0>;
   xlnx,adc-dither33;
   xlnx,mdac-refclk-freq = <6400>;
   xlnx,adc-tdd-rts23 = <0>;
   ...
   xlnx,adc-tdd-rts30 = <0>;
   xlnx,adc-slice10-enable;
   xlnx,adc2-slices = <2>;
   xlnx,adc-tdd-rts31 = <0>;
   xlnx,adc2-fs-max = <5>;
   xlnx,mdac-fabric-freq = <0>;
   xlnx,dac0-enable = <0>;
   xlnx,adc-tdd-rts32 = <0>;
   xlnx,sysref-master = <0x0>;
   xlnx,adc-tdd-rts33 = <0>;
   ...
   xlnx,name = "usp_rf_data_converter_0";
   ...
   xlnx,adc-calopt-mode00 = <1>;
   xlnx,adc-coarse-mixer-freq03 = <3>;
   xlnx,adc-data-width33 = <9>;
   xlnx,dac-nyquist01 = <0>;
   xlnx,dac-nco-phase00 = <0>;
   xlnx,dac-mode01 = <0>;
   xlnx,dac3-fbdiv = <10>;
   xlnx,adc-calopt-mode01 = <1>;
   xlnx,dac-nyquist02 = <0>;
   xlnx,dac-nco-phase01 = <0>;
   xlnx,dac-mode02 = <0>;
   xlnx,adc-calopt-mode02 = <1>;
   xlnx,silicon-revision = <1>;
   xlnx,dac-nyquist03 = <0>;
   xlnx,dac-nco-phase02 = <0>;
   xlnx,dac-mode03 = <0>;
   xlnx,dac0-interpolation = <0>;
   xlnx,adc11-dig-port = <0>;
   xlnx,adc-calopt-mode03 = <1>;
   xlnx,dac-nco-phase03 = <0>;
   xlnx,dac-data-type00 = <0>;
   xlnx,adc03-dig-port = <0>;
   xlnx,adc1-vco = <12000>;
   xlnx,dac-tdd-rts00 = <0>;
   xlnx,dac-data-type01 = <0>;
   xlnx,adc-obs-data-width20 = <8>;
   xlnx,dac-tdd-rts01 = <0>;
   xlnx,dac-data-type02 = <0>;
   xlnx,adc-obs-data-width21 = <8>;
   xlnx,adc-nco-freq00 = <0>;
   xlnx,adc-coarse-mixer-freq10 = <3>;
   xlnx,dac-tdd-rts02 = <0>;
   xlnx,dac-data-type03 = <0>;
   xlnx,adc-obs-data-width22 = <8>;
   xlnx,adc-nco-freq01 = <0>;
   xlnx,adc1-fbdiv = <24>;
   xlnx,adc-coarse-mixer-freq11 = <3>;
   xlnx,dac-tdd-rts03 = <0>;
   xlnx,dac1-sampling-rate = <0x61a800>;
   ...
   xlnx,dac-tdd-rts32 = <0>;
   xlnx,dac-mixer-type03 = <3>;
   ...
   xlnx,dac-interpolation-mode00 = <0>;
   xlnx,adc-nco-phase31 = <0>;
   xlnx,dac-interpolation-mode01 = <0>;
   xlnx,adc-nco-phase32 = <0>;
   xlnx,adc3-vco = <12000>;
   xlnx,dac-interpolation-mode02 = <0>;
   xlnx,adc-nco-phase33 = <0>;
   xlnx,adc-data-type30 = <0>;
   xlnx,dac-interpolation-mode03 = <0>;
   xlnx,adc0-clock-dist = <0>;
   xlnx,adc-data-type31 = <0>;
   xlnx,adc1-decimation = <1>;
   xlnx,adc-data-type32 = <0>;
   xlnx,adc-slice30-enable;
   xlnx,adc-data-type33 = <0>;
   xlnx,adc-decimation-mode00 = <1>;
   xlnx,dac3-vop = <20>;
   xlnx,adc20-dig-port = <1>;
   xlnx,adc-decimation-mode01 = <1>;
   xlnx,adc12-dig-port = <0>;
   xlnx,adc-decimation-mode02 = <1>;
   xlnx,adc-decimation-mode03 = <1>;
   xlnx,ip-type = <2>;
   xlnx,dac-interpolation-mode10 = <0>;
   xlnx,adc1-clock-source = <1>;
   xlnx,dac-interpolation-mode11 = <0>;
   xlnx,adc1-slices = <2>;
   xlnx,dac-interpolation-mode12 = <0>;
   xlnx,dac3-refclk-freq = <6400>;
   xlnx,adc1-fs-max = <5>;
   ...
   xlnx,adc-decimation-mode12 = <0>;
   xlnx,adc-decimation-mode13 = <0>;
   xlnx,mdac-enable = <0>;
   xlnx,dac-interpolation-mode20 = <0>;
   xlnx,dac0-link-coupling = <0>;
   xlnx,dac-interpolation-mode21 = <0>;
   xlnx,dac3-fabric-freq = <0>;
   xlnx,high-speed-adc = <1>;
   xlnx,dac-interpolation-mode22 = <0>;
   xlnx,dac-interpolation-mode23 = <0>;
   ...
   xlnx,dac-interpolation-mode33 = <0>;
   xlnx,adc0-vco = <12000>;
   xlnx,mdac-nyquist00 = <0>;
   xlnx,dac2-interpolation = <0>;
   xlnx,adc0-clock-source = <1>;
   ...
   xlnx,adc-decimation-mode32 = <0>;
   xlnx,mdac-nyquist03 = <0>;
   xlnx,dac0-vop = <20>;
   xlnx,adc-decimation-mode33 = <0>;
   xlnx,adc3-obs-fabric-freq = <0>;
   xlnx,mdac-tdd-rts00 = <0>;
   xlnx,dac3-sampling-rate = <0x61a800>;
   ...
   xlnx,adc32-dig-port = <0>;
   xlnx,mdac-mode02 = <0>;
   xlnx,dac2-refclk-freq = <6400>;
   xlnx,mdac-mode03 = <0>;
   xlnx,dac2-outdiv = <1>;
   xlnx,adc1-link-coupling = <0>;
   xlnx,adc-mixer-mode00 = <2>;
   xlnx,adc01-dig-port = <0>;
   xlnx,adc-mixer-mode01 = <2>;
   xlnx,adc-slice23-enable;
   xlnx,adc-mixer-mode02 = <2>;
   xlnx,adc-mixer-mode03 = <2>;
   xlnx,tb-dac-fft;
   xlnx,dac2-fabric-freq = <0>;
   xlnx,dac3-clock-source = <7>;
   xlnx,vnc-include-fs2-change;
   xlnx,adc-slice02-enable;
   xlnx,dac-data-width00 = <16>;
   xlnx,dac0-refclk-div = <1>;
   xlnx,adc2-clock-dist = <0>;
   xlnx,dac-decoder-mode00 = <0>;
   xlnx,dac-data-width01 = <16>;
   xlnx,adc-mixer-mode10 = <2>;
   ...
   xlnx,adc-mixer-mode22 = <2>;
   xlnx,madc-calopt-mode02 = <1>;
   xlnx,dac-decoder-mode13 = <0>;
   xlnx,adc-slice00-enable;
   xlnx,adc-mixer-type00 = <1>;
   xlnx,adc-mixer-mode23 = <2>;
   xlnx,madc-calopt-mode03 = <1>;
   xlnx,dac1-link-coupling = <0>;
   xlnx,adc-mixer-type01 = <1>;
   xlnx,adc-mixer-type02 = <1>;
   xlnx,adc-mixer-type03 = <1>;
   ...
   xlnx,adc-mixer-type20 = <1>;
   xlnx,ams-factory-var = <0>;
   xlnx,adc-mixer-type21 = <1>;
   xlnx,adc-mixer-type22 = <1>;
   xlnx,dac1-vco = <8500>;
   xlnx,adc-mixer-type23 = <1>;
   xlnx,tb-adc-fft;
   ...
   xlnx,adc-mixer-type30 = <1>;
   xlnx,adc0-refclk-div = <1>;
   xlnx,adc-mixer-type31 = <1>;
   xlnx,adc-dither00;
   xlnx,madc-link-coupling = <0>;
   xlnx,adc-mixer-type32 = <3>;
   xlnx,adc-dither01;
   xlnx,adc-mixer-type33 = <3>;
   xlnx,adc2-vco = <12000>;
   xlnx,adc-dither02;
   xlnx,dac1-clock-source = <5>;
   xlnx,adc0-outdiv = <1>;
   xlnx,adc-dither03;
   clocks = <&misc_clk_1>, <&misc_clk_1>, <&misc_clk_1>, <&misc_clk_1>, <&zynqmp_clk 71>;
   ...
   xlnx,dac0-refclk-freq = <6400>;
   xlnx,adc-tdd-rts00 = <0>;
   xlnx,adc-dither11;
   xlnx,mdac-nco-freq03 = <0>;
   xlnx,dac0-slices = <2>;
   xlnx,adc-tdd-rts01 = <0>;
   xlnx,adc-dither12;
   xlnx,dac0-fs-max = <10>;
   xlnx,adc-tdd-rts02 = <0>;
   xlnx,adc-dither13;
   xlnx,adc-tdd-rts03 = <0>;
   xlnx,adc-nyquist10 = <0>;
   xlnx,adc-nyquist11 = <0>;
   xlnx,adc-nyquist12 = <0>;
   xlnx,adc-nyquist13 = <0>;
   xlnx,dac0-fabric-freq = <0>;
   xlnx,adc-dither20;
   xlnx,adc-tdd-rts10 = <0>;
   xlnx,adc-dither21;
   xlnx,adc-tdd-rts11 = <0>;
   ...
   dac@0 {
    ...
    xlnx,slices = <0x2>;
    xlnx,pll-enable = <0x0>;
    xlnx,sampling-rate = "6.4";
    xlnx,fs-max = "10.000";
    xlnx,link-coupling = <0x0>;
    xlnx,refclk-freq = "6400.000";
    xlnx,fbdiv = <0xa>;
    xlnx,band = <0x0>;
    xlnx,enable = <0x0>;
    xlnx,refclk-div = <0x1>;
...
# 6 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts" 2
# 1 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/pcw.dtsi" 1
 &psu_cortexa53_0 {
  xlnx,psu-ep = <1>;
...
# 7 "/media/ubuntu/large/radio-zcu208/linux/project-spec/hw-description/system-top.dts" 2
/ {
 board = "zcu208";
 ...
 family = "ZynqMP";
 speed_grade = "2";
 axi_bram_ctrl_0_memory: memory@80000000 {
 ...
 cpus_a53: cpus-a53@0 {
  ...
  address-map = <0x0 0xf0000000 &amba 0x0 0xf0000000 0x0 0x10000000>,
         ...
         <0x0 0x80000000 &axi_bram_ctrl_0_memory 0x0 0x80000000 0x0 0x2000>,
         <0x0 0x80000000 &axi_bram_ctrl_0 0x0 0x80000000 0x0 0x2000>,
         <0x00000004 0x00000000 &ddr4_0_memory 0x00000004 0x00000000 0x00000001 0x00000000>,
 ...
 cpus_r5_0: cpus-r5@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x80000000 &axi_bram_ctrl_0_memory 0x80000000 0x2000>,
         <0x80000000 &axi_bram_ctrl_0 0x80000000 0x2000>,
