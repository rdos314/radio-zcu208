set_property PACKAGE_PIN AP20 [get_ports c1_sys_clk_p]
set_property PACKAGE_PIN AP19 [get_ports c1_sys_clk_n]

set_property DQS_BIAS FALSE [get_ports c1_sys_clk_p]
set_property DQS_BIAS FALSE [get_ports c1_sys_clk_n]
