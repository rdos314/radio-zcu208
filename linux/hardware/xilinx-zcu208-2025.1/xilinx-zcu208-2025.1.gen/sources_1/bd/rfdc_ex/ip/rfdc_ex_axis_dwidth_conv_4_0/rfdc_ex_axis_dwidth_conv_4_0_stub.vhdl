...
-- Command     : write_vhdl -force -mode synth_stub -rename_top rfdc_ex_axis_dwidth_conv_4_0 -prefix
--               rfdc_ex_axis_dwidth_conv_4_0_ rfdc_ex_axis_dwidth_conv_0_0_stub.vhdl
...
entity rfdc_ex_axis_dwidth_conv_4_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of rfdc_ex_axis_dwidth_conv_4_0 : entity is "rfdc_ex_axis_dwidth_conv_0_0,axis_dwidth_converter_v1_1_34_axis_dwidth_converter,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of rfdc_ex_axis_dwidth_conv_4_0 : entity is "rfdc_ex_axis_dwidth_conv_0_0,axis_dwidth_converter_v1_1_34_axis_dwidth_converter,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axis_dwidth_converter,x_ipVersion=1.1,x_ipCoreRevision=34,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_S_AXIS_TDATA_WIDTH=384,C_M_AXIS_TDATA_WIDTH=512,C_AXIS_TID_WIDTH=1,C_AXIS_TDEST_WIDTH=1,C_S_AXIS_TUSER_WIDTH=1,C_M_AXIS_TUSER_WIDTH=1,C_AXIS_SIGNAL_SET=0b00000000000000000000000000000011}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of rfdc_ex_axis_dwidth_conv_4_0 : entity is "yes";
end rfdc_ex_axis_dwidth_conv_4_0;

architecture stub of rfdc_ex_axis_dwidth_conv_4_0 is
