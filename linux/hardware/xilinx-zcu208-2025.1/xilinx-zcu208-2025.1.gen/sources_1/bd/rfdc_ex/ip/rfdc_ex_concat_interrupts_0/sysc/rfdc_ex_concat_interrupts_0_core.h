...
#ifndef _rfdc_ex_concat_interrupts_0_core_h_
#define _rfdc_ex_concat_interrupts_0_core_h_
...
class rfdc_ex_concat_interrupts_0_core : public sc_module 
{
    public: 
       rfdc_ex_concat_interrupts_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(rfdc_ex_concat_interrupts_0_core);
    ...
    virtual ~rfdc_ex_concat_interrupts_0_core() = default;
