...
--               /scratch/rfrefdesigns_2025.1_0522_1_ZCU208/trunk/HW/48_trdPllOnddr_dacddr_adcmts_ex/rfip_ex/rfip_ex.gen/sources_1/bd/rfdc_ex/ip/rfdc_ex_bufgmux_adc2_0/rfdc_ex_bufgmux_adc2_0_stub.vhdl
-- Design      : rfdc_ex_bufgmux_adc2_0
...
entity rfdc_ex_bufgmux_adc2_0 is
  ...
  attribute CHECK_LICENSE_TYPE of rfdc_ex_bufgmux_adc2_0 : entity is "rfdc_ex_bufgmux_adc2_0,bufgmux,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of rfdc_ex_bufgmux_adc2_0 : entity is "rfdc_ex_bufgmux_adc2_0,bufgmux,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=bufgmux,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
...
architecture stub of rfdc_ex_bufgmux_adc2_0 is
  ...
  attribute X_INTERFACE_PARAMETER of I1 : signal is "XIL_INTERFACENAME I1, FREQ_HZ 368640000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN rfdc_ex_rfip_0_clk_adc2, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of O : signal is "XIL_INTERFACENAME O, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN rfdc_ex_bufgmux_adc2_0_O, INSERT_VIP 0";
