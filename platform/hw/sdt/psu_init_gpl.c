...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x10040000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x10040000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    /*
    * Register : VIDEO_PSS_CLK_SEL @ 0XFF180404

    * PSS Alt Ref Clock selection 0: Select PSS Alt Ref Clock from MIO[28] 1:
    * Select PSS Alt Ref Clock from MIO[51]
    *  PSU_IOU_SLCR_VIDEO_PSS_CLK_SEL_PSS_ALT_CLK                  0

    * VIDEO_CLK and PSS_ALT_REF_CLK selection from MIO pins
    * (OFFSET, MASK, VALUE)      (0XFF180404, 0x00000002U ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_VIDEO_PSS_CLK_SEL_OFFSET,
